...
def test_path_option_1(e2e_test):
    ...
    subprocess.run(f'python3 mdt.py --path {TEST_DIR}/{SAMPLE_DIR}/sample1.md', shell=True)
...
def test_path_option_2(e2e_test):
    ...
    subprocess.run(f'python3 mdt.py --path {TEST_DIR}/{SAMPLE_DIR}/sample2.en.md', shell=True)
...
def test_path_option_3(e2e_test):
    ...
    subprocess.run(f'python3 mdt.py --path {TEST_DIR}/{SAMPLE_DIR}/sample3.ja.md --from ja --to en', shell=True)
...
def test_path_option_4(e2e_test):
    ...
    subprocess.run(f'python3 mdt.py --path {TEST_DIR}/{SAMPLE_DIR}/sample3.ja.md --from ja --to zh', shell=True)
...
def test_path_option_5(e2e_test):
    ...
    subprocess.run(f'python3 mdt.py --path {TEST_DIR}/{SAMPLE_DIR}/sample1.md --output {TEST_DIR}/{OUTPUT_DIR}', shell=True)
...
def test_path_option_6(e2e_test):
    ...
    subprocess.run(f'python3 mdt.py --path {TEST_DIR}/{SAMPLE_DIR}/sample3.ja.md --output {TEST_DIR}/{OUTPUT_DIR} --from ja --to en', shell=True)
...
def test_path_option_7(e2e_test):
    ...
    subprocess.run(f'python3 mdt.py --path {TEST_DIR}/{SAMPLE_DIR}', shell=True)
    assert os.path.exists(f'{TEST_DIR}/{SAMPLE_DIR}/sample1.ja.md')
    assert os.path.exists(f'{TEST_DIR}/{SAMPLE_DIR}/sample2.ja.md')
    os.remove(f'{TEST_DIR}/{SAMPLE_DIR}/sample1.ja.md')
    os.remove(f'{TEST_DIR}/{SAMPLE_DIR}/sample2.ja.md')
...
def test_path_option_8(e2e_test):
    ...
    subprocess.run(f'python3 mdt.py --path {TEST_DIR}/{SAMPLE_DIR} --from ja --to en', shell=True)
    assert os.path.exists(f'{TEST_DIR}/{SAMPLE_DIR}/sample3.md')
    os.remove(f'{TEST_DIR}/{SAMPLE_DIR}/sample3.md')
...
def test_path_option_9(e2e_test):
    ...
    subprocess.run(f'python3 mdt.py --path {TEST_DIR}/{SAMPLE_DIR} -r', shell=True)
    assert os.path.exists(f'{TEST_DIR}/{SAMPLE_DIR}/sample1.ja.md')
    assert os.path.exists(f'{TEST_DIR}/{SAMPLE_DIR}/sample2.ja.md')
...
def test_path_option_10(e2e_test):
    ...
    subprocess.run(f'python3 mdt.py --path {TEST_DIR}/{SAMPLE_DIR} -r --from ja --to en', shell=True)
    assert os.path.exists(f'{TEST_DIR}/{SAMPLE_DIR}/sample3.md')
...
def test_path_option_11(e2e_test):
    ...
    subprocess.run(f'python3 mdt.py --path {TEST_DIR}/{SAMPLE_DIR} --output {TEST_DIR}/{OUTPUT_DIR}', shell=True)
    assert os.path.exists(f'{TEST_DIR}/{OUTPUT_DIR}/sample1.md')
...
def test_path_option_12(e2e_test):
    ...
    subprocess.run(f'python3 mdt.py --path "{TEST_DIR}/{CASE_DIR}/filename with space.md"', shell=True)
...
def test_no_hugo_option(e2e_test):
    ...
    subprocess.run(f'python3 mdt.py --path README.md --no-hugo', shell=True)
...
def test_deepl_option(e2e_test):
    ...
    subprocess.run(f'python3 mdt.py --path {TEST_DIR}/{SAMPLE_DIR}/sample1.md --deepl-free', shell=True)
    assert os.path.exists(f'{TEST_DIR}/{SAMPLE_DIR}/sample1.ja.md')
    os.remove(f'{TEST_DIR}/{SAMPLE_DIR}/sample1.ja.md')
