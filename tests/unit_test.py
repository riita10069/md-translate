...
def test_html_tag_1(unit_test):
    ...
    translate_page(f'{TEST_PATH}/sample1', const.LANG_EN, const.LANG_JA, False, False, False, True, f'./', True, "", "")
...
def test_html_tag_2(unit_test):
    ...
    translate_page(f'{TEST_PATH}/sample2', const.LANG_EN, const.LANG_JA, False, False, False, True, f'./', False, "", "")
...
def test_html_tag_3(unit_test):
    ...
    translate_page(f'{TEST_PATH}/nested_html', const.LANG_EN, const.LANG_JA, False, False, False, True, f'./', False, "", "")
...
def test_html_tag_4(unit_test):
    ...
    translate_page(f'{TEST_PATH}/nested_html_with_text', const.LANG_EN, const.LANG_JA, False, False, False, True, f'./', False,
                   "", "")
...
def test_dictionary_1(unit_test):
    ...
    translate_page(f'{TEST_PATH}/base_ignore_words', const.LANG_EN, const.LANG_JA, False, False, False, True, f'./', False,
...
def test_dictionary_2(unit_test):
    print("test base_ignore_words")
    translate_page(f'{TEST_PATH}/base_custom_words', const.LANG_EN, const.LANG_JA, False, False, False, True, f'./', False,
                   DICTIONARY_PATH, os.path.join(DICTIONARY_PATH, get_latest_translation_history_file(DICTIONARY_PATH)))
